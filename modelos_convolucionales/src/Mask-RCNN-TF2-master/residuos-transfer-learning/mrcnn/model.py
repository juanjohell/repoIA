...
def data_generator(dataset, config, shuffle=False, augment=False, augmentation=None,
    ...
    print("len image_ids "+str(len(image_ids)))
    error_count = 0
    ...
    while True:
        try:
            ...
            #print(str(image_index + 1)+" % "+str(len(image_ids)))

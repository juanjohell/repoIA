...
#########################################
# ATENCION A LAS LIBRERIAS C++ 2015 DE  #
# VISUALSTUDIO QUE DEBEN DE ESTAR       #
# INSTALADAS EN EL EQUIPO               #
# PARA LA EJECUCION DE LAS COCOTOOLS    #
#########################################
...
def main():
    ...
    train_img_nums = -1
    train_coco_json = '../../datasets/uav-bd/train/images/uav-db.json'
    #SITUAR EL JSON DONDE LAS IAGENES
    val_coco_json = '../../datasets/uav-bd/val/images/uav-db.json'
    ...
    for epoch in range(epochs):
        ...
        yolo.yolov5.save_weights(save_dir+"/yolov{}-last.h5".format(yolov5_type))
        print("save {}/yolov{}-last.h5 last weights at epoch {}.".format(save_dir, yolov5_type, epoch))
        yolo.yolov5.save(save_dir+"/yolov{}-last.h5".format(yolov5_type))

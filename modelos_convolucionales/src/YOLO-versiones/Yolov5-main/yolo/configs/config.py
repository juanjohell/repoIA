...
parser.add_argument('--train_annotations_dir', type=str, default='etiquetas_train.txt', help='train annotations path')
parser.add_argument('--test_annotations_dir', type=str, default='etiquetas_val.txt', help='test annotations path')
parser.add_argument('--class_name_dir', type=str, default='trash_classes.txt', help='classes name path')
...
parser.add_argument('--saved_model_dir', type=str, default='../yolov5', help='saved pb model path')
parser.add_argument('--saved_model_dir_keras', type=str, default='../yolov5_keras', help='saved pb model path')
parser.add_argument('--saved_format', type=str, default='h5', help='saved format')
parser.add_argument('--n_epochs', type=int, default=NUMERO_EPOCHS)

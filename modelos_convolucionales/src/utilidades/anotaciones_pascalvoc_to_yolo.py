...
# BOINDING BOXES PORQUE ESTAN ROTADOS Y SE TRANS-     #
...
txt_train_dir = "../../datasets/uav-bd/train/labels_txt/"
...
txt_val_dir = "../../datasets/uav-bd/val/labels_txt/"
...
etiquetas_val = open('etiquetas_val_espacios.txt', 'w')
...
for e,i in enumerate(os.listdir(xml_val_dir)) :
    ...
    etiquetas_val.write(imagePath+' ')  # path a la imagen
...
etiquetas_train = open('etiquetas_train_espacios.txt', 'w')

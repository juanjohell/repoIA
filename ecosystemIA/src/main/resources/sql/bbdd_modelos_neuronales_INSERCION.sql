...
INSERT INTO `modelos` (`ID_MODELO`, `NOMBRE`, `DESCRIPCION`, `FICHEROH5`, `INPUT_HEIGHT`, `INPUT_WIDTH`, `INPUT_CHANNELS`, `FORMATO_MATRIZ_IMG`, `PATH_FICHERO`, `TIPO_ALMACENAMIENTO`, `TIPO_FICHERO`, `TIPO_PREDICCION`, `TIPO_SALIDA`) VALUES
	(1, 'Cifar10', 'modelo de clasificación de imágenes entrenado con DATASET Cifar10, 10 Epochs', NULL, 32, 32, 3, NULL, 'modelos\\\\cifar10_entrenado_10epochs.h5', 2, 1, 1, 1),
	(2, 'r-cnn_vgg16 entrenado con UAV-DB', 'modelo de reconocimiento de objetos en imágenes, basado en el modelo preentrenado VGG16', NULL, 224, 224, 3, NULL, 'modelos\\\\rcnn_VGG16_reconocimiento_botellas.h5', 2, 1, 2, 2),
	(12, 'yolov3', 'modelo YOLO 3', NULL, 416, 416, 3, NULL, 'modelos\\\\yolov5\\\\saved_model.pb', 2, 2, 2, 2),
	(14, 'VGG19 Imagenet', 'VGG19 modelo de clasificación de imágenes entrenado con el dataset ImageNet', NULL, 224, 224, 3, NULL, 'modelos\\\\model_imagenet_vgg19.h5', 2, 1, 1, 2);
...
INSERT INTO `tipo_prediccion` (`idTipoPrediccion`, `nombre`, `descripccion`) VALUES
